            ...
            <div className="container w-50">
                <a-scene style={size} embedded>
                    <a-assets>
                        ...
                        <a-asset-item id="embroidery" src="/models/embroidery/embroidery.obj"></a-asset-item>
                        <a-asset-item id="material" src="/models/t-shirt/Tshirt.mtl"></a-asset-item>
                        <img id="embroidery-image" src={`data:image/${image.extension};base64,${image.base64StringFile}`} alt=""/>
                    </a-assets>
                    <a-camera id="camera" orbit-controls="target: #target;
                              enableDamping: true;
                              dampingFactor: 0.125;
                              rotateSpeed: 0.25;
                              rotateToSpeed: 0.04;
                        ...
                        <a-entity id="target" obj-model="obj: #object; mtl: #material"
                                  position="0 3 -15" rotation="0 -90 0" scale="10 10 10"></a-entity>
                        <a-entity id="embroidery" obj-model="obj: #embroidery;"
                                  material="normalMap: #my-image; sphericalEnvMap: #embroidery-image; src: #embroidery-image"
                                  position="0 3 -15" rotation="0 -90 0" scale="10 10 10"></a-entity>
                </a-scene>
            </div>
